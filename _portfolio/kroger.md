...
next-cs-link: yum
phases: Discovery
overview: My focus for this project was to make a recommendation for replacing a piece of 35+-year-old software called ChainTrack. ChainTrack is used across the enterprise for receiving certain types of products through the docks at Kroger stores, a process called Direct Store Delivery, or DSD, where products like Coke, Fritos, and alcohol come into the store. Kroger DSD intakes ~28 Billion dollars of products using this software. <br><br>This was a three-person team, a Product Manager, a Tech Lead, and myself, tasked with researching and understanding enough to recommend building our own or purchasing a replacement product. The research and recommendation work was heavily driven by me.
stat-number: $28B
stat-label: Products intake through DSD Receiving, yearly
...
process-caption05: Product flow presentation
