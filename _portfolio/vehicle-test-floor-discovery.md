...
next-cs-link: kroger
phases: Discovery
overview: The client runs a large vehicle test facility used by both its own engineering staff and an outside operations partner who run tests on behalf of third-party clients. The facility had grown well past what its original tools and processes could support, and nobody had stepped back to ask the people running daily testing what actually got in their way. I was the product consultant on a two-person Discovery team that spent roughly two months observing testing on-site and interviewing the technicians and operators who ran it, then delivered a severity-rated findings report and a recommendation for what was, and wasn't, worth building software to fix.
...
scope: About two months of on-site Discovery (December 2023 through February 2024) with a two-person Callibrity team, which the client extended into a three-month custom-build engagement
...
methods: <ul><li>Made four separate on-site visits over roughly ten weeks, arriving when technicians did and staying through full test days to observe testing as it actually happened</li><li>Ran dozens of one-on-one interviews, in person and virtual, with technicians and operators across both operating teams</li><li>Used a consistent, deliberately redundant interview script across every conversation, so the same topic asked a different way would surface things people hadn't thought to mention the first time</li><li>Interviewed people one at a time rather than in groups, to avoid stronger personalities dominating and groupthink flattening the feedback</li><li>Adapted the Nielsen Norman Group's 0-to-4 heuristic-evaluation severity scale to rate every finding, even though the environment was physical operations, not software</li></ul>
...
outcomes: <ul><li>Four on-site visits and dozens of 1:1 interviews across two operating teams over roughly ten weeks</li><li>Eleven severity-rated findings delivered in a 28-page report, plus a summary deck for stakeholders</li><li>Three findings scoped into a proposed digital-product build; the other eight scoped as process and documentation fixes instead of custom software</li><li>The client extended the engagement into a three-month custom-build phase, turning the recommendation into funded, delivered work</li></ul>
achievements: <ul><li>Adapted a UX heuristic-evaluation framework to a physical operations environment that had never used one</li><li>Recommended process and documentation fixes over new software on eight of eleven findings</li><li>Built enough trust with a time-constrained technical team to get honest, specific feedback during live test days without disrupting testing</li><li>Turned a two-month Discovery engagement into a three-month funded build, the recommendation converting directly into follow-on work</li></ul>
...
learnings: This is the engagement that taught me a Discovery process doesn't care what's on the other side of it, software, a physical facility, or a set of manual procedures. The interview script, the severity ratings, and writing down every friction point even when it wouldn't become a product all transferred directly from web and app work onto a physical test floor. It also reinforced something I still apply now&colon; sometimes the most valuable recommendation is that a finding doesn't need new software built for it.
...
<!--
  ...
  Report.pdf" (88 pages, dated March 2024, authored by Tim Grannen,
  Technical Consultant, and Ryan Wilson, Product Consultant) and
  ...
  - Did not name the third-party operations partner ("GoKen" in the
    ...
    Drew, Tim Grannen) - all replaced with role-based language ("the
    operations partner," "a Callibrity technical consultant," etc.) or
    omitted.
